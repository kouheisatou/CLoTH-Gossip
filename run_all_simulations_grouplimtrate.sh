...
for j in $(seq 0 0.01 1.0); do
    enqueue_simulation "./run-simulation.sh $seed $output_dir/routing_method=group_routing/avg_pmt_amt=1000/group_limit_rate=$j        $dijkstra_cache_dir/method=group_routing,seed=$seed,n_payments=$n_payments,avg_pmt_amt=1000     n_payments=$n_payments mpp=0 routing_method=group_routing      group_cap_update=true      average_payment_amount=1000    group_size=5 group_limit_rate=$j"
    enqueue_simulation "./run-simulation.sh $seed $output_dir/routing_method=group_routing/avg_pmt_amt=10000/group_limit_rate=$j       $dijkstra_cache_dir/method=group_routing,seed=$seed,n_payments=$n_payments,avg_pmt_amt=10000    n_payments=$n_payments mpp=0 routing_method=group_routing      group_cap_update=true      average_payment_amount=10000   group_size=5 group_limit_rate=$j"
    enqueue_simulation "./run-simulation.sh $seed $output_dir/routing_method=group_routing/avg_pmt_amt=100000/group_limit_rate=$j      $dijkstra_cache_dir/method=group_routing,seed=$seed,n_payments=$n_payments,avg_pmt_amt=100000   n_payments=$n_payments mpp=0 routing_method=group_routing      group_cap_update=true      average_payment_amount=100000  group_size=5 group_limit_rate=$j"
    enqueue_simulation "./run-simulation.sh $seed $output_dir/routing_method=group_routing/avg_pmt_amt=1000000/group_limit_rate=$j     $dijkstra_cache_dir/method=group_routing,seed=$seed,n_payments=$n_payments,avg_pmt_amt=1000000  n_payments=$n_payments mpp=0 routing_method=group_routing      group_cap_update=true      average_payment_amount=1000000 group_size=5 group_limit_rate=$j"
done
