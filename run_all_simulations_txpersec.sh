...
for i in $(seq 1.0 1.0 4.0); do
    ...
    for j in $(seq 0.0 0.2 3.0); do
        ...
        n_payments="50000"  # based on simulation settings used by CLoTH paper https://www.sciencedirect.com/science/article/pii/S2352711021000613
        timeout="60000"  # based on CLoTH implementation
        enqueue_simulation "./run-simulation.sh $seed $output_dir/routing_method=ideal/average_payment_amount=$avg_pmt_amt/payment_rate=$payment_rate             $dijkstra_cache_dir/method=ideal,n_payments=$n_payments,avg_pmt_amt=$avg_pmt_amt           log_all_events=true payment_timeout=$timeout payment_rate=$payment_rate n_payments=$n_payments mpp=0 routing_method=ideal          group_cap_update=        average_payment_amount=$avg_pmt_amt group_size=  group_limit_rate="
        enqueue_simulation "./run-simulation.sh $seed $output_dir/routing_method=channel_update/average_payment_amount=$avg_pmt_amt/payment_rate=$payment_rate    $dijkstra_cache_dir/method=channel_update,n_payments=$n_payments,avg_pmt_amt=$avg_pmt_amt  log_all_events=true payment_timeout=$timeout payment_rate=$payment_rate n_payments=$n_payments mpp=0 routing_method=channel_update group_cap_update=        average_payment_amount=$avg_pmt_amt group_size=  group_limit_rate="
        enqueue_simulation "./run-simulation.sh $seed $output_dir/routing_method=cloth_original/average_payment_amount=$avg_pmt_amt/payment_rate=$payment_rate    $dijkstra_cache_dir/method=cloth_original,n_payments=$n_payments,avg_pmt_amt=$avg_pmt_amt  log_all_events=true payment_timeout=$timeout payment_rate=$payment_rate n_payments=$n_payments mpp=0 routing_method=cloth_original group_cap_update=        average_payment_amount=$avg_pmt_amt group_size=  group_limit_rate="
        enqueue_simulation "./run-simulation.sh $seed $output_dir/routing_method=group_routing/average_payment_amount=$avg_pmt_amt/payment_rate=$payment_rate     $dijkstra_cache_dir/method=group_routing,n_payments=$n_payments,avg_pmt_amt=$avg_pmt_amt   log_all_events=true payment_timeout=$timeout payment_rate=$payment_rate n_payments=$n_payments mpp=0 routing_method=group_routing  group_cap_update=true    average_payment_amount=$avg_pmt_amt group_size=5 group_limit_rate=0.1"
    done
done
