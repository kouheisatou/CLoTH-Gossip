...
#    enqueue_simulation "./run-simulation.sh $seed $output_dir/routing_method=ideal/payment_rate=$payment_rate             $dijkstra_cache_dir/method=ideal,n_payments=50000           log_all_events=true payment_timeout=60000 payment_rate=$payment_rate n_payments=50000 mpp=0 routing_method=ideal          group_cap_update=        average_payment_amount=10000 group_size=  group_limit_rate="
#    enqueue_simulation "./run-simulation.sh $seed $output_dir/routing_method=channel_update/payment_rate=$payment_rate    $dijkstra_cache_dir/method=channel_update,n_payments=50000  log_all_events=true payment_timeout=60000 payment_rate=$payment_rate n_payments=50000 mpp=0 routing_method=channel_update group_cap_update=        average_payment_amount=10000 group_size=  group_limit_rate="
#    enqueue_simulation "./run-simulation.sh $seed $output_dir/routing_method=group_routing/payment_rate=$payment_rate     $dijkstra_cache_dir/method=group_routing,n_payments=50000   log_all_events=true payment_timeout=60000 payment_rate=$payment_rate n_payments=50000 mpp=0 routing_method=group_routing  group_cap_update=true    average_payment_amount=10000 group_size=5 group_limit_rate=0.1"
#done
...
for i in $(seq 1.0 1.0 4.0); do
    ...
    for j in $(seq 0.0 0.5 3.0); do
        payment_rate=$(python3 -c "print('{:.0f}'.format(10**($j)))")
        enqueue_simulation "./run-simulation.sh $seed $output_dir/routing_method=ideal/average_payment_amount=$average_payment_amount/payment_rate=$payment_rate             $dijkstra_cache_dir/method=ideal,n_payments=50000           log_all_events=true payment_timeout=60000 payment_rate=$payment_rate n_payments=50000 mpp=0 routing_method=ideal          group_cap_update=        average_payment_amount=$average_payment_amount group_size=  group_limit_rate="
        enqueue_simulation "./run-simulation.sh $seed $output_dir/routing_method=channel_update/average_payment_amount=$average_payment_amount/payment_rate=$payment_rate    $dijkstra_cache_dir/method=channel_update,n_payments=50000  log_all_events=true payment_timeout=60000 payment_rate=$payment_rate n_payments=50000 mpp=0 routing_method=channel_update group_cap_update=        average_payment_amount=$average_payment_amount group_size=  group_limit_rate="
        enqueue_simulation "./run-simulation.sh $seed $output_dir/routing_method=group_routing/average_payment_amount=$average_payment_amount/payment_rate=$payment_rate     $dijkstra_cache_dir/method=group_routing,n_payments=50000   log_all_events=true payment_timeout=60000 payment_rate=$payment_rate n_payments=50000 mpp=0 routing_method=group_routing  group_cap_update=true    average_payment_amount=$average_payment_amount group_size=5 group_limit_rate=0.1"
    done
done
