...
#    avg_pmt_amt="44700"  # based on statics https://river.com/learn/files/river-lightning-report-2023.pdf?ref=blog.river.com
    avg_pmt_amt="1000"  # value such that success_rate=0.8~0.6
    n_payments="1000000"  # based on simulation settings used by CLoTH paper https://www.sciencedirect.com/science/article/pii/S2352711021000613
